...
<table border="1" cellspacing="0px" cellpadding="4px" style="width:100%">
    ...
    <tr style="font-size:12px">
        ...
        <th style="width:50%;border-left:none;font-size: 10px;border-left:none;padding-top: 0px;" align="center" class="head" >
            ...
            <h4>e-Mail:<?= $email ?></h4>
            <h4><b>CIN No: <?= $cin_no ?>; PAN#: <?= $pan ?></b></h4>   
            <h4><b>GST  :# <?= $gst ?></b></h4>
        </th>
    </tr>
<!--    <tr>
    ...
    <tr>
        <td colspan="2" class="" style="padding-left:0px">
            <table width="100%" border="1" style="font-size:9px;width: 100%;margin-left:0px !important" cellpadding="2px">
...
?></th> <th>Delivery Contact:</th><th><?= $contact ?></th></tr>
             ...
             <table border="1px" width="100%" cellspacing="0px" cellpadding="3px">
                            <tr>
<th colspan="2"  class="bgcolor" align="center" style="width:50%"><b>Bill to Party</b></th><th colspan="2" class="bgcolor"  align="center" style="width:50%"><b>Ship to Party</b></th></tr>
                            <tr><th style="width:17%">Name:</th>
<th class="font10" style="width:33%"><?= $billto_name ?></th>
<th style="width:17%">Name:</th>
<th class="font10" style="width:33%"><?= $seller_name ?></th></tr>
                            <tr><th>Address:</th>
<th><?= $billto_address ?></th><th>Address:</th>
<th><?= $seller_address ?></th></tr>
                            <tr><th>GSTIN:</th>
<th><?= $billto_gst ?></th><th>GSTIN:</th>
<th><?= $seller_gst ?></th></tr>
                            <tr><th>State Name / Code</th>
<th><?= $seller_state . "(" . $billto_state_code . ")" ?></th><th>State Name / Code</th>
<th><?= $seller_state . "(" . $seller_state_code . ")" ?></th></tr>
    ...
    <tr>
        <td colspan="2" class="">
            <table border="1" cellspacing="0px" cellpadding="2px"  style="font-size:6px;width:100%" width="100%">
                <tr>
                    <th rowspan="2" class="bgcolor" style="width:6%" align="center">S.No.</th>  
                    <th rowspan="2" class="bgcolor" style="width:12%">Product Description (Scientific Name)</th>
                    <th rowspan="2" class="bgcolor" style="width:5%">HSN code</th>
                    <th rowspan="2" class="bgcolor" style="width:5%">Ordered Qty</th>  
                    <th rowspan="2" class="bgcolor" style="width:5%">Case / Box Qty</th>
                    <th rowspan="2" class="bgcolor" style="width:4.5%">Total Qty</th>  
                    <th rowspan="2" class="bgcolor" style="width:6%">Basic Price</th>
                    <th rowspan="2" class="bgcolor" style="width:7%">Amount</th>  
                    <th rowspan="2" class="bgcolor" style="min-width:5%">Discount In %</th>
                    <th rowspan="2" class="bgcolor" style="width:7%">Taxable Value</th>  
                    <th colspan="2" class="bgcolor" align="center" style="width:13.5%">SGST</th>
                    <th colspan="2" class="bgcolor" align="center" style="width:13.5%">CGST</th>
                    <th rowspan="2" class="bgcolor" style="width:9%" align="center">Total</th>
                </tr>
                <tr>
...
if (isset($items["records"])) {
    ...
    while ($i < count($items["records"])) {
        ...
        $cgst_amount = ($net_amount * $cgst) / 100;     //used
        $sgst_amount = ($net_amount * $sgst) / 100;     //used
        $total_amount = round($net_amount + $cgst_amount + $sgst_amount, 2);  //used
        ...
        $total_sgst_amount += $sgst_amount;  //used
        $total_cgst_amount += $cgst_amount;  //used
        //  $total_igst_amount += $igst_amount;  //used
        $total_cart_amount += $total_amount;   //used
        if (!isset($tax_array[$sgst])) {
            $tax_array[$sgst] = array();
            $tax_array[$sgst] = array();
            $tax_array[$sgst]["taxable"] = $net_amount;
        } else {
            $tax_array[$sgst]["taxable"] = $tax_array[$sgst]["taxable"] + $net_amount;
        }
        ...
        ?>
                        <tr>
                            ...
                            <td align="right"><?= number_format($sgst_amount, 2, '.', '') ?></td>
                            <td align="center"><?= $cgst ?> %</td>
                            <td align="right"><?= number_format($cgst_amount, 2, '.', '') ?></td>
...
?>
                <tr>
                    ...
                    <td align="right"></td>
                    <td align="right"><?= number_format($total_sgst_amount, 2, '.', '') ?></td>
                    <td align="right"></td>
                    <td align="right"><?= number_format($total_cgst_amount, 2, '.', '') ?></td>
...
Total Amount before Tax</td><td rowspan="2" style="text-align:right"> <?= number_format($total_net_amount,2,'.','') ?>
</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4">DUE AS ON DATE:  <?= $items['credit_date']; ?></td>
                    <td colspan="5">AMOUNT: <?php echo number_format($wallet,2,'.','') ; //$round_value
?></td>
                ...
                <tr>
                    <td colspan="3" class="bgcolor">BANK DETAILS </td>
                    <td colspan="6" class="bgcolor">TAX SUMMARY </td>
                ...
                <tr>
                    <td>A/C</td>
                    <td colspan="2"><?= $branch_acc_no ?></td>
                    <td colspan="6" rowspan="5">
                        <table style="width:100%" cellpadding="2px" cellspacing="0px" border="1">
                            <tr><td style="min-width:30%">Taxable Amount</td><td>SGST %</td><td>SGST Amount</td><td>CGST %</td><td>CGST Amount</td></tr>
<?php
$stax_summary = 0.00;
$ctax_summary = 0.00;
$stax_disc = 0.00;
...
foreach ($tax_array as $key => $value) {
    $stax_disc = ($tax_array[$key]["taxable"] * $key) / 100;
    $ctax_disc = ($tax_array[$key]["taxable"] * $key) / 100;
    $stax_summary = $stax_summary + $stax_disc;
    $ctax_summary = $ctax_summary + $ctax_disc;
    ?> 
                                <tr>
                                    <td align="right"><?= number_format($tax_array[$key]["taxable"], 2, '.', '') ?></td>
                                    <td align="center"><?= $key ?>%</td>
                                    <td align="right"><?= number_format($stax_disc, 2, '.', '') ?></td>
                                    <td align="center"><?= $key ?>%</td>
                                    <td align="right"><?= number_format($ctax_disc, 2, '.', '') ?></td>

                                </tr>
    <?php
}
?>
                            <tr><td colspan="2" align="center">Total </td><td align="right"><?= number_format($stax_summary, 2, '.', '') ?></td><td></td><td align="right"><?= number_format($ctax_summary, 2, '.', '') ?></td></tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>Name</td>
                    <td colspan="2"><?= $branch_acc_holder_name ?></td>
                ...
                <tr>
                    <td>Bank</td>
                    <td colspan="2"><?= $branch_bank_name ?></td>

                    <td rowspan="3" colspan="5">Total Invoice</td>
                    <td rowspan="3" align="right"><?= number_format($round_value, 2, '.', '') ?></td>

                </tr>
                <tr>
                    <td>Branch</td>
                    <td colspan="2"><?= $branch_bank_branch ?></td>
                ...
                <tr>
                    <td>IFSC</td>
                    <td colspan="2"><?= $branch_bank_ifsc ?></td>
                ...
                <tr>
                    ...
                    <td colspan="6" style="text-align:center"  rowspan="6" >
                ...
                <tr>
                    <td colspan="9" class="bgcolor"><h5>DECLARATION</h5></td>
                ...
                <tr>
                    ...
                    <!--<td colspan="6" align="center" style="border:none;">xfsdfsfd</td> -->

                </tr>
                <tr><td colspan="15" align="center">SUBJECT TO HYDERABAD JURISDICTION</td></tr>
